...
public enum EpsonProjectorCommandType {
    ...
    DISPLAY_3D("Display3D", SwitchItem.class),
    FORMAT_3D("Format3D", StringItem.class),
    BRIGHTNESS_3D("Brightness3D", StringItem.class),
    IR_EMITTER_3D("IREmitter3D", StringItem.class),
    VIEWING_NOTICE_3D("ViewingNotice3D", SwitchItem.class),
